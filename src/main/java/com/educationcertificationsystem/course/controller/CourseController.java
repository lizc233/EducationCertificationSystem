...
public class CourseController {
    ...
    public Result<EduCourseObjectiveIndicatorPoint> updateObjectiveSupport(@PathVariable Long id, @RequestBody EduCourseObjectiveIndicatorPoint support) {
    ...
    public Result<EduCourseContentObjectiveRel> updateContentRelation(@PathVariable Long id, @RequestBody EduCourseContentObjectiveRel relation) {
    ...
    public Result<EduCourseAssessmentMethod> createAssessmentMethod(@PathVariable Long courseId, @RequestBody EduCourseAssessmentMethod method) {
    ...
    public Result<EduCourseAssessmentMethod> updateAssessmentMethod(@PathVariable Long id, @RequestBody EduCourseAssessmentMethod method) {
    ...
    public Result<EduCourseAssessmentStandard> updateAssessmentStandard(@PathVariable Long id, @RequestBody EduCourseAssessmentStandard standard) {
